...
const faqs = [
  {
    ...
    answer:
      "Tech Mail은 RSS 피드를 활용하여 기술 블로그의 새 글을 모니터링합니다. 매일 오전 7시에 모은 새 글들을 정리해서 이메일로 전송합니다.",
  },
  {
    question: "이메일은 언제 오나요?",
    answer:
      "매일 오전 7시에 전날 수집된 모든 새 글을 정리해서 일괄 전송합니다. 이렇게 하면 이메일 알림이 너무 많아지지 않고 깔끔하게 확인할 수 있어요.",
  },
  {
    question: "구독은 무료인가요?",
    answer:
