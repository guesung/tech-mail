...
const faqs = [
  {
    ...
    answer:
      "Tech Mail은 RSS 피드를 활용하여 기술 블로그의 새 글을 실시간으로 모니터링합니다. 새 글이 발행되면 구독자에게 이메일로 알림을 보냅니다.",
  },
  {
    question: "구독은 무료인가요?",
    answer:
  ...
  {
    question: "이메일 알림은 언제 오나요?",
    answer:
      "새 글이 발행되면 평균 5분 내에 이메일 알림을 받으실 수 있습니다. RSS 피드를 실시간으로 확인하여 빠른 알림을 제공합니다.",
  },
  {
